...
export default async function decorate(block) {
  ...
  if (resp.ok) {
    ...
    avisbook.innerHTML = "<div class=\"form block\" data-block-name=\"form\"><div><div><a href=\"https://main--xsc-wkndnew--chrisjejbrown.hlx.live/en/fragments/avisbook.json\">"+navForm+".json</a></div></div</div>";
